...
<div class="vidseo-row">
    ...
    <div class="vidseo-column col-8">
        ...
        <label class="vidseo-switch">
            ...
            <input type="checkbox" id="vidseo_muted" name="vidseo_muted" value="true" <?php if ( $options::check('vidseo_muted') ) { echo  'checked' ;  } ?> />
...
<div class="vidseo-row">
    ...
    <div class="vidseo-column col-8">
        ...
        <label class="vidseo-switch">
            ...
            <input type="checkbox" id="vidseo_vimeo_title" name="vidseo_vimeo_title" value="true" <?php if ( $options::check('vidseo_vimeo_title') ) { echo  'checked' ;  } ?> />
...
<div class="vidseo-row">
    ...
    <div class="vidseo-column col-8">
        ...
        <label class="vidseo-switch">
            ...
            <input type="checkbox" id="vidseo_author" name="vidseo_author" value="true" <?php if ( $options::check('vidseo_author') ) { echo  'checked' ;  } ?> />
